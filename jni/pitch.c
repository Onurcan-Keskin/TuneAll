...
Java_com_example_tunn_Tuner_getPitch(JNIEnv *env, jobject obj, jfloatArray inputArray) {
...
JNIEXPORT jfloat JNICALL
Java_com_onurcankeskin_tunein_Tuner_getPitch(JNIEnv *env, jobject obj, jfloatArray inputArray) {
    // TODO: implement getPitch()
    aubio_pitch_t * o = (aubio_pitch_t *) (*env)->GetLongField(env, obj, getPtrFieldId(env, obj));
    fvec_t *input = (fvec_t *) (*env)->GetLongField(env, obj, getInputFieldId(env, obj));
    fvec_t *pitch = (fvec_t *) (*env)->GetLongField(env, obj, getPitchFieldId(env, obj)); // input buffer
...
Java_com_onurcankeskin_tunein_Tuner_initPitch(JNIEnv *env, jobject obj, jint sampleRate, jint bufferSize) {
    // TODO: implement initPitch()
...
JNIEXPORT void JNICALL
Java_com_onurcankeskin_tunein_Tuner_cleanupPitch(JNIEnv *env, jobject obj) {
    // TODO: implement cleanupPitch()
    aubio_pitch_t * o = (aubio_pitch_t *) (*env)->GetLongField(env, obj, getPtrFieldId(env, obj));
    fvec_t *input = (fvec_t *) (*env)->GetLongField(env, obj, getInputFieldId(env, obj));
    fvec_t *pitch = (fvec_t *) (*env)->GetLongField(env, obj, getPitchFieldId(env, obj)); // input buffer
    del_aubio_pitch (o);
...
JNIEXPORT jfloat JNICALL
Java_com_onurcankeskin_looneytune_Tuner_getPitch(JNIEnv *env, jobject obj, jfloatArray inputArray) {
    // TODO: implement getPitch()
    aubio_pitch_t * o = (aubio_pitch_t *) (*env)->GetLongField(env, obj, getPtrFieldId(env, obj));
    fvec_t *input = (fvec_t *) (*env)->GetLongField(env, obj, getInputFieldId(env, obj));
    fvec_t *pitch = (fvec_t *) (*env)->GetLongField(env, obj, getPitchFieldId(env, obj)); // input buffer
...
JNIEXPORT void JNICALL
Java_com_onurcankeskin_looneytune_Tuner_initPitch(JNIEnv *env, jobject obj, jint sampleRate,
                                                  jint bufferSize) {
    // TODO: implement initPitch()
    unsigned int win_s = (unsigned int) bufferSize; // window size
    unsigned int hop_s = win_s / 4; // hop size
...
JNIEXPORT void JNICALL
Java_com_onurcankeskin_looneytune_Tuner_cleanupPitch(JNIEnv *env, jobject obj) {
    // TODO: implement cleanupPitch()
    aubio_pitch_t * o = (aubio_pitch_t *) (*env)->GetLongField(env, obj, getPtrFieldId(env, obj));
    fvec_t *input = (fvec_t *) (*env)->GetLongField(env, obj, getInputFieldId(env, obj));
    fvec_t *pitch = (fvec_t *) (*env)->GetLongField(env, obj, getPitchFieldId(env, obj)); // input buffer
